...
<head>
    ...
    <link rel="stylesheet"
        href="<?php echo _WEB_ROOT; ?>/public/admin/assets/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
    <!-- iCheck -->
    <link rel="stylesheet"
        href="<?php echo _WEB_ROOT; ?>/public/admin/assets/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
    <!-- JQVMap -->
    ...
    <!-- overlayScrollbars -->
    <link rel="stylesheet"
        href="<?php echo _WEB_ROOT; ?>/public/admin/assets/plugins/overlayScrollbars/css/OverlayScrollbars.min.css">
    <!-- Daterange picker -->
    <link rel="stylesheet"
        href="<?php echo _WEB_ROOT; ?>/public/admin/assets/plugins/daterangepicker/daterangepicker.css">
    <!-- summernote -->
    <link rel="stylesheet"
        href="<?php echo _WEB_ROOT; ?>/public/admin/assets/plugins/summernote/summernote-bs4.min.css">
