                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput" name="company_location" placeholder="name@example.com" value="<?php echo $item['company_location'] ?>" />
                                <label for="floatingInput">Địa điểm</label>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput" name="scales" placeholder="name@example.com" value="<?php echo $item['scales'] ?>" />
                                <label for="floatingInput">Quy mô</label>
                            </div>
                        </div>
                        <div class="col-12 mt-3">
                            <div class="form-floating mb-3">
                                <textarea class="form-control editor" placeholder="Leave a comment here" name="company_description" id="floatingTextarea2" style="height: 200px"><?php echo $item['company_description'] ?></textarea>
