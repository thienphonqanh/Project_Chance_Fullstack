            ...
            <form method="post" class="m-auto" enctype="multipart/form-data">
                ...
                <div class="shadow p-2 rounded-2">
                    ...
                    <div class="form-group mx-lg-4 mx-md-3 mx-sm-2 mx-1">
                        ...
                        <label class="text-primary border border-1 px-4 py-2 border-primary rounded-2 btn-upload-avatar custom-btn-profile text-center"><i class="bi bi-upload"></i> Tải file</label>
                        <p class="fs-6 fw-normal p-0 m-0 mt-2 text-center text-sm-center text-md-center text-lg-start">Hỗ
                            trợ định dạng .doc, .docx, .pdf có kích thước dưới 5MB</p>
                    ...
                    <div class="row p-lg-4 p-md-3 p-sm-2 p-1 mt-2 mt-sm-2 mt-md-2 mt-lg-0">
                        <?php if (!empty($profileInformation)) : ?>
                            ...
                            <div class="col-lg-12 text-end mt-2">
                                <a class="btn btn-danger px-5 rounded-3 py-2" href="<?php echo _WEB_ROOT; ?>/jobs/ho-so-ung-vien">Quay lại</a>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
