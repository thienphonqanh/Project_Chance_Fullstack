...
<section class="content">
    <div class="container-fluid">
        ...
        <hr>
        <a type="button" href="<?php echo _WEB_ROOT; ?>/jobs/them-moi" class="btn btn-primary px-3"><i class="bi bi-plus-circle-dotted px-1"></i> Thêm việc làm</a>
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td class="text-center"><a href="<?php echo _WEB_ROOT; ?>/jobs/danh-sach/thong-tin?id=<?php echo $item['id'] ?>" class="btn btn-primary btn-sm"><i class="bi bi-eye"></i>
                                        Xem</a></td>
