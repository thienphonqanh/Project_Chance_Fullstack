    ...
    <form method="post" class="text-center shadow-lg p-4 rounded-3">
        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <div class="form-floating mb-3 text-start">
                    <input type="text" class="form-control" id="floatingInput" name="location" placeholder="name@example.com"
            ...
            <div class="col-12">
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" name="contact_facebook" id="floatingInput" placeholder="name@example.com"
            ...
            <div class="col-12">
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" name="contact_twitter" id="floatingInput" placeholder="name@example.com"
            ...
            <div class="col-12">
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" name="contact_linkedin" id="floatingInput" placeholder="name@example.com"
