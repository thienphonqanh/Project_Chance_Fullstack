    ...
    <form method="post" class="text-center shadow-lg p-4 rounded-3" enctype="multipart/form-data">
        ...
        <div class="row">
            <?php if (!empty($dataProfile)) : ?>
                ...
                <div class="col-6">
                    <div class="form-floating mb-3 text-start">
                        <input type="email" class="form-control" id="floatingInput" name="email" placeholder="name@example.com" value="<?php echo $dataProfile['email']; ?>">
                    ...
                    <div class="form-floating mb-3 text-start">
                        <input type="date" class="form-control" id="floatingInput" name="dob" placeholder="name@example.com" value="<?php echo $dataProfile['dob']; ?>">
                    ...
                    <div class="form-floating mb-3 text-start">
                        <input type="text" class="form-control" id="floatingInput" name="location" placeholder="name@example.com" value="<?php echo $dataProfile['location']; ?>">
                        <label for="floatingInput">Tỉnh/Thành phố hiện tại</label>
                    </div>
                </div>
                <div class="col-6">
                    <div class="form-floating mb-3 text-start">
                        <input type="text" class="form-control" id="floatingInput" name="phone" placeholder="name@example.com" value="<?php echo $dataProfile['phone']; ?>">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="address" id="floatingInput" placeholder="name@example.com" value="<?php echo $dataProfile['address']; ?>">
                        <label for="floatingInput">Địa chỉ (Tên đường, quận/huyện,...)</label>
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="contact_facebook" id="floatingInput" placeholder="name@example.com" value="<?php echo $dataProfile['contact_facebook']; ?>">
                        <label for="floatingInput">Link Facebook</label>
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="contact_twitter" id="floatingInput" placeholder="name@example.com" value="<?php echo $dataProfile['contact_twitter']; ?>">
                        <label for="floatingInput">Link Twitter</label>
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="contact_linkedin" id="floatingInput" placeholder="name@example.com" value="<?php echo $dataProfile['contact_linkedin']; ?>">
                        <label for="floatingInput">Link LinkedIn</label>
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-group">
                        <textarea class="form-control" placeholder="Giới thiệu bản thân" name="about_content" rows="8"><?php echo $dataProfile['about_content']; ?></textarea>
                    </div>
                </div>
