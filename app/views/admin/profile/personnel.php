    ...
    <form method="" class="text-center shadow-lg p-4 rounded-3">
        ...
        <div class="row">
            <?php if (!empty($dataProfile)) : ?>
                ...
                <div class="col-6">
                    <div class="form-floating mb-3">
                        <input type="email" class="form-control" disabled id="floatingInput" name="email" placeholder="name@example.com" value="<?php echo $dataProfile['email']; ?>">
                        <label for="floatingInput">Địa chỉ email <span class="text-danger fw-bold">*</span></label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="date" class="form-control" disabled id="floatingInput" name="dob" placeholder="name@example.com" value="<?php echo $dataProfile['dob']; ?>">
                        <label for="floatingInput">Ngày sinh <span class="text-danger fw-bold">*</span></label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" disabled id="floatingInput" name="location" placeholder="name@example.com" value="<?php echo $dataProfile['location']; ?>">
                        <label for="floatingInput">Tỉnh/Thành phố hiện tại</label>
                    </div>
                </div>
                <div class="col-6">
                    <div class="form-floating mb-3">
                        <input type="email" class="form-control" disabled id="floatingInput" name="phone" placeholder="name@example.com" value="<?php echo $dataProfile['phone']; ?>">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" disabled name="address" id="floatingInput" placeholder="name@example.com" value="<?php echo $dataProfile['address']; ?>">
                        <label for="floatingInput">Địa chỉ (Tên đường, quận/huyện,...)</label>
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-floating mb-3">
                        <input type="email" class="form-control" disabled name="contact_facebook" id="floatingInput" placeholder="name@example.com" value="<?php echo $dataProfile['contact_facebook']; ?>">
                        <label for="floatingInput">Link Facebook</label>
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-floating mb-3">
                        <input type="email" class="form-control" disabled name="contact_twitter" id="floatingInput" placeholder="name@example.com" value="<?php echo $dataProfile['contact_twitter']; ?>">
