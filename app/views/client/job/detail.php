                    ...
                    <div class="row align-items-center w-100 mt-3">
                        <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                            <div class="d-flex align-items-center">
                                <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/icon-coin.png" width="30px" height="30px" alt="">
                                <p class="fs-6 fw-normal m-0 ms-2">Mức lương <strong class="text-info"><?php echo $item['salary']; ?></strong></p>
                            </div>
                        </div>
                        <div class="col-lg-8 col-md-12 col-sm-12 col-12">
                            <div class="d-flex align-items-center ms-lg-3 mt-md-3 mt-sm-3 mt-2 mt-lg-0">
                                <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/icon-schedual.png" width="30px" height="30px" alt="">
                                <p class="fs-6 fw-normal m-0 ms-2">Hạn nộp hồ sơ <strong class="text-dark"><?php echo getDateTimeFormat($item['deadline'], 'd-m-Y'); ?></strong></p>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex align-items-center w-100 mt-3">
                        <div class="d-flex align-items-center">
                            <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/icon-map.png" width="30px" height="30px" alt="">
                            <p class="fs-6 fw-normal m-0 ms-2">Khu vực tuyển <strong class="text-dark"><?php echo $item['location']; ?></strong></p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center w-100 mt-3">
                        <div class="d-flex align-items-center">
                        ...
                        <p class="text-dark fs-6 fw-normal m-0 ms-auto"><i class="bi bi-eye"></i> Lượt xem <?php echo $item['view_count']; ?></p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="d-flex align-items-center">
                                <div class="d-flex align-items-center w-25">
                                    ...
                                    <div class="ms-3">
                                        ...
                                        <p class="fs-6 fw-bold m-0"><?php echo getDateTimeFormat($item['create_at'], 'd-m-Y'); ?></p>
                                    </div>
                                </div>
