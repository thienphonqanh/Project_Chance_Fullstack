        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav align-items-center ms-lg-5">
                    <li class="nav-item">
                        <a class="nav-link p-3 text-dark fw-normal"
                            href="<?php echo _WEB_ROOT; ?>/cam-nang/la-ban-su-nghiep">La bàn sự nghiệp</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link p-3 text-dark fw-normal"
                            href="<?php echo _WEB_ROOT; ?>/cam-nang/tram-sac-ky-nang">Trạm sạc kỹ năng</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link p-3 text-dark fw-normal"
                            href="<?php echo _WEB_ROOT; ?>/cam-nang/toa-do-nhan-tai">Toạ độ nhân tài</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link p-3 text-dark fw-normal"
                            href="<?php echo _WEB_ROOT; ?>/cam-nang/ki-ot-vui-ve">Ki ốt vui vẻ</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link p-3 text-dark fw-normal" href="<?php echo _WEB_ROOT; ?>/trang-chu"><i
                    ...
                    <li class="nav-item ms-lg-auto">
                        <a class="nav-link handbook-login text-dark p-2 fw-bold" type="button"
                            href="<?php echo _WEB_ROOT; ?>/dang-nhap"><i class="bi bi-person-circle p-1"></i> Đăng
                            nhập</a>
                    </li>
