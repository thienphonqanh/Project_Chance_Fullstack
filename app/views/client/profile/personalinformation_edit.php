<div>
    <div class="container-lg p-2 mt-2 m-auto">
        <form method="post" class="text-center shadow-lg p-4 rounded-3" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 text-lg-start text-sm-center text-center text-md-start mt-3">
                    <a href="<?php echo _WEB_ROOT; ?>/thong-tin-ca-nhan" class="btn btn-md btn-danger">Quay lại</a>
