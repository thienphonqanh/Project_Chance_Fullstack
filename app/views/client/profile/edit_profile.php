    ...
    ?>
        ...
        <form method="post" style="width: 80%; height: auto;" class="mx-4" enctype="multipart/form-data">
            ...
            <div class="shadow p-2 rounded-2">
                ...
                <div class="form-group mx-4">
                    <div class="d-flex align-items-center mt-2">
                        <p id="file-name" class="m-0 p-0 text-success rounded-2 py-1 px-5">
                    ...
                    <label for="upload-cv"
                        class="text-primary border border-1 px-4 py-2 border-primary rounded-2 btn-upload-avatar"><i
                            class="bi bi-upload"></i> Tải file</label>
                    <p class="fs-6 fw-normal p-0 m-0 mt-2">Hỗ trợ định dạng .doc, .docx, .pdf có kích thước dưới 5MB</p>
                    <input type="file" id="upload-cv" name="upload-cv" accept=".pdf, .doc, .docx"
                        onchange="validateFile()" class="d-none">
                </div>
            </div>
            ...
            <div class="shadow p-2 rounded-2 mt-3">
                ...
                <div class="row p-4">
                    <div class="col-lg-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="fullname"
                                value="<?php echo $information['fullname']; ?>" disabled>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="location"
                                value="<?php echo $information['location']; ?>" disabled>
                        </div>
                        <div class="form-group mb-3">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="date" class="form-control" name="dob"
                                value="<?php echo $information['dob']; ?>" disabled>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="address"
                                value="<?php echo $information['address']; ?>" disabled>
                        </div>
                        <div class="form-group mb-3">
                            <label for="phone" class="fw-semibold mb-2">Số điện thoại</label>
                            <input type="text" class="form-control" name="phone"
                                value="<?php echo $information['phone']; ?>" disabled>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="contact_facebook" disabled
                                value="<?php echo $information['contact_facebook']; ?>">
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="contact_twitter" disabled
                                value="<?php echo $information['contact_twitter']; ?>">
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="contact_linkedin" disabled
                                value="<?php echo $information['contact_linkedin']; ?>">
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group mb-3">
                    ...
                    <div class="col-lg-12 text-end mt-3">
                        <a type="button" href="<?php echo _WEB_ROOT; ?>/quan-ly-tai-khoan/tai-khoan"
                            class="btn border border-1 border-primary py-2 px-5 text-primary btn-save-info">Chỉnh
                            sửa</a>
                    </div>
                </div>
            </div>
                ...
                <div class="row p-4">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="job_desired"
            ...
            <div class="sticky-bottom text-end ms-lg-auto mt-3 p-3" style="background-color: var(--section-color);">
                <button type="submit" href="<?php echo _WEB_ROOT; ?>/quan-ly-tai-khoan/tai-khoan"
