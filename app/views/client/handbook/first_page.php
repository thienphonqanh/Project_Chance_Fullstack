...
<section class="section-header">
    <div class="container-lg">
        <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/la-ban-su-nghiep/Laban-Sunghiep-Banner.png" class="img-fluid mt-lg-2" alt="">
        <a href="#">
            <div class="row mt-4 w-full">
                <div class="col-lg-6 col-md-12">
                    <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/la-ban-su-nghiep/nghi-duong-suc-sau-sinh.webp" class="mt-lg-2 img-fluid rounded-2" alt="">
                </div>
                <div class="col-lg-6 col-md-12">
        ...
        <div class="row mt-lg-4">
            <div class="col-lg-4 col-md-4 mt-3 mt-lg-4">
                <a href="#" class="handbook-item d-block">
                    <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/la-ban-su-nghiep/viec-lam-online-cho-sinh-vien.webp" class="img-fluid rounded-3" alt="">
                    <div class="mt-2 w-100 px-3 py-2 d-flex flex-column">
            ...
            <div class="col-lg-4 col-md-4 mt-3 mt-lg-4">
                <a href="#" class="handbook-item d-block">
                    <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/la-ban-su-nghiep/cach-gui-cv-qua-email.webp" class="img-fluid rounded-3" alt="">
                    <div class="mt-2 w-100 px-3 py-2 d-flex flex-column">
            ...
            <div class="col-lg-4 col-md-4 mt-3 mt-lg-4">
                <a href="#" class="handbook-item d-block">
                    <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/la-ban-su-nghiep/thuc-tap-sinh-kinh-doanh.webp" class="img-fluid rounded-3" alt="">
                    <div class="mt-2 w-100 px-3 py-2 d-flex flex-column">
                        <p class="text-uppercase fw-normal fs-6 text-dark m-0">Định hướng</p> 
