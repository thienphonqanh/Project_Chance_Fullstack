...
<section class="section-header">
    <div class="container-lg">
        <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/tram-sac-ky-nang/Tramsac-Kynang-Banner.png" class="img-fluid mt-lg-2" alt="">
        <a href="#">
            <div class="row mt-4 w-full">
                <div class="col-lg-6 ">
                    <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/tram-sac-ky-nang/ai-anxiety.webp" class="mt-lg-2 img-fluid rounded-2" alt="">
                </div>
                <div class="col-lg-6">
...
<section class="section-main">
    <div class="container-lg">
        <div class="row mt-lg-4">
            ...
            <div class="col-lg-4 col-md-4 mt-3">
                <a href="#" class="handbook-item d-block">
                    <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/tram-sac-ky-nang/workload-la-gi.webp" class="img-fluid rounded-3" alt="">
                    <div class="mt-2 w-100 px-3 py-2 d-flex flex-column">
                        <p class="text-uppercase fw-normal fs-6 text-dark m-0">Kiến thức văn phòng</p> 
