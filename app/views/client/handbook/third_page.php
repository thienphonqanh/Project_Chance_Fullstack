...
<section class="section-header">
            <div class="container-lg">
                <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/toa-do-nhan-tai/Toado-Sannhantai-Banner.png" class="img-fluid mt-lg-2" alt="">
                <a href="#">
                    <div class="row mt-4 w-full">
                        <div class="col-lg-6 ">
                            <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/toa-do-nhan-tai/phuc-loi-nhan-vien.webp" class="mt-lg-2 img-fluid rounded-2" alt="">
                        </div>
                        <div class="col-lg-6">
                ...
                <div class="row mt-lg-4">
                    <div class="col-lg-4 col-md-4 mt-3">
                        <a href="#" class="handbook-item d-block">
                            <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/toa-do-nhan-tai/ho-so-nhan-su.webp" class="img-fluid rounded-3" alt="">
                            <div class="mt-2 w-100 px-3 py-2 d-flex flex-column">
                    ...
                    <div class="col-lg-4 col-md-4 mt-3">
                        <a href="#" class="handbook-item d-block">
                            <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/toa-do-nhan-tai/reference-check.webp" class="img-fluid rounded-3" alt="">
                            <div class="mt-2 w-100 px-3 py-2 d-flex flex-column">
                                <p class="text-uppercase fw-normal fs-6 text-dark m-0">Toạ độ nhân tài</p> 
                    ...
                    <div class="col-lg-4 col-md-4 mt-3">
                        <a href="#" class="handbook-item d-block">
                            <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/toa-do-nhan-tai/Hiring-freeze-.webp" class="img-fluid rounded-3" alt="">
                            <div class="mt-2 w-100 px-3 py-2 d-flex flex-column">
                                <p class="text-uppercase fw-normal fs-6 text-dark m-0">Toạ độ nhân tài</p> 
                    ...
                    <div class="col-lg-4 col-md-4 mt-3">
                        <a href="#" class="handbook-item d-block">
                            <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/toa-do-nhan-tai/qr-thanh-toan.png" class="img-fluid rounded-3" alt="">
                            <div class="mt-2 w-100 px-3 py-2 d-flex flex-column">
                    ...
                    <div class="col-lg-4 col-md-4 mt-3">
                        <a href="#" class="handbook-item d-block">
                            <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/toa-do-nhan-tai/ebook-doc-quyen.png" class="img-fluid rounded-3" alt="">
                            <div class="mt-2 w-100 px-3 py-2 d-flex flex-column">
                                <p class="text-uppercase fw-normal fs-6 text-dark m-0">Tài liệu độc quyền</p> 
                    ...
                    <div class="col-lg-4 col-md-4 mt-3">
                        <a href="#" class="handbook-item d-block">
                            <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/toa-do-nhan-tai/bien-chatgpt-thanh-tro-ly.png" class="img-fluid rounded-3" alt="">
                            <div class="mt-2 w-100 px-3 py-2 d-flex flex-column">
                    ...
                    <div class="col-lg-4 col-md-4 mt-3">
                        <a href="#" class="handbook-item d-block">
                            <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/toa-do-nhan-tai/làm-4-ngày-1-tuần.jpg" class="img-fluid rounded-3" alt="">
                            <div class="mt-2 w-100 px-3 py-2 d-flex flex-column">
                    ...
                    <div class="col-lg-4 col-md-4 mt-3">
                        <a href="#" class="handbook-item d-block">
                            <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/toa-do-nhan-tai/thi-truong-tuyen-dung.png" class="img-fluid rounded-3" alt="">
                            <div class="mt-2 w-100 px-3 py-2 d-flex flex-column">
                                <p class="text-uppercase fw-normal fs-6 text-dark m-0">Báo cáo - Xu hướng</p> 
                    ...
                    <div class="col-lg-4 col-md-4 mt-3">
                        <a href="#" class="handbook-item d-block">
                            <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/toa-do-nhan-tai/tuyển-dụng-hậu-covid-19.jpg" class="img-fluid rounded-3" alt="">
                            <div class="mt-2 w-100 px-3 py-2 d-flex flex-column">
                                <p class="text-uppercase fw-normal fs-6 text-dark m-0">Báo cáo - Xu hướng</p> 
