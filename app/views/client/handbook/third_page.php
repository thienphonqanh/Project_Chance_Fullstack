...
<section class="section-header">
    <div class="container-lg">
        ...
        <div>
            <a href="<?php echo _WEB_ROOT; ?>/chi-tiet-bai-viet/<?php echo $thirdPageHandbook[0]['slug'].'-'.$thirdPageHandbook[0]['id']; ?>">
                <div class="row mt-4 w-full">
                    ...
                    <div class="col-lg-6">
                        <div class="mt-2 w-100 px-3 py-2 d-flex flex-column">
                            <p class="text-uppercase fw-normal fs-5 text-dark m-0"><?php echo $thirdPageHandbook[0]['name']; ?></p>
                            <h3 class="tilte-handbook"><?php echo $thirdPageHandbook[0]['title']; ?></h3>
                            <span class="special-content text-dark fw-lighter fs-5"><?php echo $thirdPageHandbook[0]['descr']; ?></span>
                        </div>
                    </div>
                </div>
            </a>
