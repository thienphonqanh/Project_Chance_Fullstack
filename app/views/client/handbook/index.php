            ...
            <div class="col-lg-8 col-md-8 mt-2">
                ...
                <a href="#">
                    <div class="mt-3 w-100">
                        <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/la-ban-su-nghiep/cong-viec-cho-nguoi-huong-noi-1.webp" class="img-fluid rounded-4" alt="">
                        <div class="mt-3 p-2">
                ...
                <a href="#">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-6">
                            <div class="mt-2">
                                <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/toa-do-nhan-tai/reference-check.webp" class="img-fluid rounded-4" alt="">
                                <div class="mt-2">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-6">
                            <div class="mt-5 mt-sm-2">
                                <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/la-ban-su-nghiep/phu-cap-trach-nhiem.webp" class="img-fluid rounded-4" alt="">
                                <div class="mt-2">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 mt-3">
                        <a href="#" class="handbook-item d-block">
                            <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/tram-sac-ky-nang/don-khieu-nai-1-1.jpg" class="img-fluid rounded-3" alt="">
                    ...
                    <div class="col-lg-4 col-md-4 mt-3">
                        <a href="#" class="handbook-item d-block">
                            <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/tram-sac-ky-nang/mau-thu-ngo.jpg" class="img-fluid rounded-3" alt="">
                            <div class="mt-2 w-100 px-3 py-2 d-flex flex-column">
                                <p class="text-uppercase fw-normal fs-6 text-dark m-0">Kiến thức văn phòng</p> 
                    ...
                    <div class="col-lg-4 col-md-4 mt-3">
                        <a href="#" class="handbook-item d-block">
                            <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/tram-sac-ky-nang/thu-chao-hang.jpg" class="img-fluid rounded-3" alt="">
                            <div class="mt-2 w-100 px-3 py-2 d-flex flex-column">
                                <p class="text-uppercase fw-normal fs-6 text-dark m-0">Kiến thức văn phòng</p> 
                    ...
                    <div class="col-lg-4 col-md-4 mt-3">
                        <a href="#" class="handbook-item d-block">
                            <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/tram-sac-ky-nang/qua-bom-hen-gio-anh-huong-su-nghiep.jpg" class="img-fluid rounded-3" alt="">
                            <div class="mt-2 w-100 px-3 py-2 d-flex flex-column">
        ...
        <div class="mt-5">
            ...
            <div>
                <div class="row">
                    <div class="col-lg-4 col-md-4 mt-3">
                        <a href="#" class="handbook-item d-block">
                            <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/la-ban-su-nghiep/phu-cap-trach-nhiem.webp" class="img-fluid rounded-3" alt="">
                            <div class="mt-2 w-100 px-3 py-2 d-flex flex-column">
                    ...
                    <div class="col-lg-4 col-md-4 mt-3">
                        <a href="#" class="handbook-item d-block">
                            <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/la-ban-su-nghiep/so-thich-trong-cv.webp" class="img-fluid rounded-3" alt="">
                            <div class="mt-2 w-100 px-3 py-2 d-flex flex-column">
                    ...
                    <div class="col-lg-4 col-md-4 mt-3">
                        <a href="#" class="handbook-item d-block">
                            <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/la-ban-su-nghiep/thuc-tap-sinh-it.webp" class="img-fluid rounded-3" alt="">
                            <div class="mt-2 w-100 px-3 py-2 d-flex flex-column">
                    ...
                    <div class="col-lg-4 col-md-4 mt-3">
                        <a href="#" class="handbook-item d-block">
                            <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/la-ban-su-nghiep/cong-viec-cho-nguoi-huong-noi-1.webp" class="img-fluid rounded-3" alt="">
                            <div class="mt-2 w-100 px-3 py-2 d-flex flex-column">
                                <p class="text-uppercase fw-normal fs-6 text-dark m-0">Định hướng</p> 
                    ...
                    <div class="col-lg-4 col-md-4 mt-3">
                        <a href="#" class="handbook-item d-block">
                            <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/la-ban-su-nghiep/thuc-tap-sinh-ngan-hang.webp" class="img-fluid rounded-3" alt="">
                            <div class="mt-2 w-100 px-3 py-2 d-flex flex-column">
                                <p class="text-uppercase fw-normal fs-6 text-dark m-0">Định hướng</p> 
                    ...
                    <div class="col-lg-4 col-md-4 mt-3">
                        <a href="#" class="handbook-item d-block">
                            <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/la-ban-su-nghiep/nghi-viec-truoc-tet.webp" class="img-fluid rounded-3" alt="">
                            <div class="mt-2 w-100 px-3 py-2 d-flex flex-column">
                                <p class="text-uppercase fw-normal fs-6 text-dark m-0">La bàn sự nghiệp</p> 
        ...
        <div class="mt-5">
            ...
            <div>
                <div class="row">
                    <div class="col-lg-4 col-md-4 mt-3">
                        <a href="#" class="handbook-item d-block">
                            <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/ki-ot-vui-ve/Podcast-chua-lanh.jpg" class="img-fluid rounded-3" alt="">
                            <div class="mt-2 w-100 px-3 py-2 d-flex flex-column">
                    ...
                    <div class="col-lg-4 col-md-4 mt-3">
                        <a href="#" class="handbook-item d-block">
                            <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/ki-ot-vui-ve/chi-so-su-menh.jpg" class="img-fluid rounded-3" alt="">
                            <div class="mt-2 w-100 px-3 py-2 d-flex flex-column">
                    ...
                    <div class="col-lg-4 col-md-4 mt-3">
                        <a href="#" class="handbook-item d-block">
                            <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/ki-ot-vui-ve/big-five-1-1.jpg" class="img-fluid rounded-3" alt="">
                            <div class="mt-2 w-100 px-3 py-2 d-flex flex-column">
                    ...
                    <div class="col-lg-4 col-md-4 mt-3">
                        <a href="#" class="handbook-item d-block">
                            <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/ki-ot-vui-ve/chi-so-thai-do.jpg" class="img-fluid rounded-3" alt="">
                            <div class="mt-2 w-100 px-3 py-2 d-flex flex-column">
                                <p class="text-uppercase fw-normal fs-6 text-dark m-0">Góc tâm linh</p> 
                    ...
                    <div class="col-lg-4 col-md-4 mt-3">
                        <a href="#" class="handbook-item d-block">
                            <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/ki-ot-vui-ve/kim-tu-thap-than-so-hoc.jpg" class="img-fluid rounded-3" alt="">
                            <div class="mt-2 w-100 px-3 py-2 d-flex flex-column">
                                <p class="text-uppercase fw-normal fs-6 text-dark m-0">Góc tâm linh</p> 
                    ...
                    <div class="col-lg-4 col-md-4 mt-3">
                        <a href="#" class="handbook-item d-block">
                            <img src="<?php echo _WEB_ROOT; ?>/public/client/assets/images/handbook/ki-ot-vui-ve/chi-so-duong-doi.jpg" class="img-fluid rounded-3" alt="">
                            <div class="mt-2 w-100 px-3 py-2 d-flex flex-column">
                                <p class="text-uppercase fw-normal fs-6 text-dark m-0">Góc tâm linh</p> 
