        ...
        <ul class="p-0 m-0">
            <li>
                ...
                <div class="collapse show" id="collapseExample-1">
                    <ul class="p-0 m-0 px-2 rounded-1">
                        <li
                            class="py-1 <?php echo (handleActiveSidebar('quan-ly-tai-khoan', 'tai-khoan') ? 'active' : false) ?>">
                            <a href="<?php echo _WEB_ROOT; ?>/quan-ly-tai-khoan/tai-khoan"
            ...
            <li>
                ...
                <div class="collapse show" id="collapseExample-3">
                    <ul class="p-0 m-0 px-2 rounded-1">
                        <li class="py-1">
                            <a href="#" class="text-dark fw-normal fs-6 mx-3">
                                <i class="bi bi-file-earmark-check-fill text-primary"></i> Việc làm đã ứng tuyển
                            </a>
                        </li>
                        <li class="py-1">
                            <a href="#" class="text-dark fw-normal fs-6 mx-3">
                                <i class="bi bi-heart-fill text-primary"></i> Việc làm đã lưu
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <li>
                <div class="d-inline-flex gap-1 p-0">
                    <a class="btn border border-0 p-0 m-0 px-3 py-2 fw-bold text-dark" data-bs-toggle="collapse"
                        href="#collapseExample-4" role="button" aria-expanded="false" aria-controls="collapseExample">
