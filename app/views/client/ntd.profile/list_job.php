                        ...
                        <td class="text-center">
                            <div>
                                <button class="btn border-0" type="button" data-bs-toggle="dropdown"
                                    aria-expanded="false">
                                    <i class="bi bi-three-dots p-2 rounded-5 text-primary"
                                        style="background-color: var(--section-bg-color);"></i>
                                </button>
                                <ul class="dropdown-menu text-center border-primary">
                                    <li><a class="dropdown-item"
                                            href="<?php echo _WEB_ROOT; ?>/ntd/quan-ly-dang-tuyen/danh-sach/chinh-sua?id=<?php echo $item['id']; ?>">Sửa</a>
                                    </li>
                                    <li><a class="dropdown-item"
                                            href="<?php echo _WEB_ROOT; ?>/ntd/quan-ly-dang-tuyen/danh-sach/xoa?id=<?php echo $item['id']; ?>">Xoá</a>
                                    </li>
                                </ul>
                            </div>
                        </td>
                    </tr>
                    <?php endforeach; elseif ($quantityJob === 0): ?>
                    <tr>
                        <td colspan="7" class="text-center">
                            ...
                            <a href="<?php echo _WEB_ROOT; ?>/ntd/quan-ly-dang-tuyen/tao-tin"
                                class="btn text-white py-2 px-5 mb-5"
                                style="background-color: var(--primary-color);">Đăng tin ngay</a>
                        </td>
                    </tr>
                    <?php else: ?>
                    <tr>
