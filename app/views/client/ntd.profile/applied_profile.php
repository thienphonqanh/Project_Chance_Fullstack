        ...
        <div class="shadow p-4 rounded-3 mt-2 m-auto custom-form-profile">
            ...
            <table class="table mt-4">
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                <td><a class="text-dark" href="<?php echo _WEB_ROOT; ?>/ntd/quan-ly-ung-vien/ho-so-ung-tuyen/xem-ho-so?id=<?php echo $item['candidate_id']; ?>"><?php echo $item['fullname']; ?></a>
                                </td>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo _WEB_ROOT; ?>/ntd/quan-ly-ung-vien/ho-so-ung-tuyen/gui-email?id=<?php echo $item['id']; ?>" class="btn btn-sm btn-primary text-white">Gửi email</a>
                                </td>
                            </tr>
                        <?php endforeach;
                    else : ?>
