<form action="" method="post" class="mt-3">
    ...
    <a href="#" class="link-block btn border border-2 rounded-5 w-100 mt-4"><svg width="18" height="18"
            ...
            <path
                ...
                fill="#fff" transform="translate(-16.172 -6.041)" />
            ...
            <g transform="">
                <g fill-rule="evenodd">
                    ...
                    <path
                        ...
                        fill="#34a853" />
                    <path d="m3.964 10.71a5.321 5.321 0 0 1 0-3.42v-2.332h-3.007a9.011 9.011 0 0 0 0 8.084z"
                        fill="#fbbc05" />
                    <path
    ...
    <a href="#" class="link-block btn border border-2 rounded-5 w-100 mt-4"><svg width="20" height="20"
